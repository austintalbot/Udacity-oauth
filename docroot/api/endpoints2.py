...
def puppiesFunction():
  if request.method == 'GET': #Call the method to Get all of the puppies
    return getAllPuppies()

  elif request.method == 'POST': #Call the method to make a new puppy
...
def puppiesFunctionId(id):
  if request.method == 'GET': #Call the method to get a specific puppy based on their id
    return getPuppy(id)
  if request.method == 'PUT': #Call the method to update a puppy
    return updatePuppy(id)
  elif request.method == 'DELETE': #Call the method to remove a puppy
