...
def gconnect():
    ...
    try:
        ...
        oauth_flow = flow_from_clientsecrets('./static/client_secrets.json', scope='')
...
def deleteRestaurant(restaurant_id):
    ...
    if restaurantToDelete.user_id != login_session['user_id']:
        return """<script>function myfunction()
        {alert('you are not authorized to delete this restaurant. please create your own restaurant in order to delete.');}</script><body onload='myfunction'>"""
    if request.method == 'POST':
...
if __name__ == '__main__':
  ...
  app.debug = False
  app.run(host = '0.0.0.0', port = 5000, ssl_context=('./static/cert.pem', './static/key.pem'))
